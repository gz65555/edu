...
var ResourceUtil = (function () {
    ...
    var d = __define,c=ResourceUtil,p=c.prototype;
    /**
     * 添加一个配置文件
     ...
     * @param $onResourceLoadTarget 资源加载监听函数所属对象
     */
    p.loadResource = function ($resources, $onResourceLoadComplete, $onResourceLoadProgress, $onResourceLoadTarget) {
    ...
    p.loadPicAsyn = function (path, bm, width, height) {
...
egret.registerClass(ResourceUtil,'ResourceUtil');
